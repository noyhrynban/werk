...
pub static mut silk_pitch_contour_iCDF: [opus_uint8; 34] = [
     223, 201, 183, 167, 152, 138, 124, 111, 98, 88, 79, 70, 62, 56, 50, 44, 39, 35, 31, 27, 24,
     21, 18, 16, 14, 12, 10, 8, 6, 4, 3, 2, 1, 0,
];
/*  11 */
#[no_mangle]
...
/*   3 */
#[no_mangle]
pub static mut silk_pitch_contour_10_ms_NB_iCDF: [opus_uint8; 3] = [113, 63, 0];
